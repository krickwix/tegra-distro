...
ROOTFS_POSTPROCESS_COMMAND:remove:gbear = "read_only_rootfs_hook;"
ROOTFS_POSTPROCESS_COMMAND:append:gbear = "${@bb.utils.contains('IMAGE_FEATURES', 'read-only-rootfs', ' replacement_read_only_rootfs_hook;', '', d)}"
